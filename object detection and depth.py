...
#img = cv.imread("C:/scientific project/sample - 12/023153.jpg")
img = cv.imread("F:/Downloads/CARLA_0.9.11/WindowsNoEditor/PythonAPI/examples/tutorial/output/004712.jpg")
#img = cv.imread("C:/Users/HP/PycharmProjects/pythonProject1/car.jfif")
...
#### LOAD MODEL
## Coco Names
classesFile = "C:/Users/HP/PycharmProjects/pythonProject1/coco.names"
classNames = []
...
modelConfiguration = "C:/Users/HP/PycharmProjects/pythonProject1/yolov3-spp.cfg"
#modelWeights = "yolov3-spp.weights"
modelWeights = "C:/Users/HP/PycharmProjects/pythonProject1/yolov3-spp.weights"
...
#a = np.loadtxt("C:/scientific project/sample - 12/points.txt")
a = np.loadtxt("F:/Downloads/CARLA_0.9.11/WindowsNoEditor/PythonAPI/examples/points.txt")
...
def rns(point_list):
    ...
    model_robust, inliers = ransac(data, LineModelND, min_samples=2, residual_threshold=1, max_trials=1500)
